...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Interactive command line tool for performing test calculations for investment return."
    )
    parser.add_argument(
        "u_init", metavar="u_init", type=int, help="Post upvotes at time of investment."
    )
    parser.add_argument(
        "u_final", metavar="u_final", type=int, help="Post upvotes at maturation of investment."
    )
    parser.add_argument(
        "invested",
        metavar="invested",
    ...
    if args.net_worth:
        ...
        olds = list(
            range(args.u_init, args.u_final * 2, args.net_worth)
